  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col">
        {/* The heading, the formats, then the pair of controls under them.
            These used to arrive in three beats as the reader reached the band;
            the page no longer moves on scroll, so the band is simply here. The
            panel keeps its own fade on a tab change, which is a change the
            reader asked for. */}
        <SectionHeading
          id={headingId}
          heading={heading}
