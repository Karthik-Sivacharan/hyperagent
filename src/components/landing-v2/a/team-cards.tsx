  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        {/* Three cards side by side from `md`. They used to arrive left to
            right as the row crossed the fold; the page no longer moves on
            scroll, so they are simply the row. */}
