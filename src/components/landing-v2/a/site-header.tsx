...
// The page's only chrome, kept from v1 with this variant's links: the
// wordmark, five in-page links (hidden below lg; the footer repeats them),
// Log in and the ink Start button. It sticks on the paper ground at 85% with
// the glass blur and one hairline, and it never animates.
