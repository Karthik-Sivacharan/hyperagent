...
// The OpenClaw mark on the "Import from OpenClaw" settings card, copied
// verbatim from docs/reference/pages/settings.html. The gradient id is a
// React useId on the site too (the dump shows `_r_5_`).
