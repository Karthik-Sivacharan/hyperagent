...
// phone they stack, 44px tall like the hero's. The actions never shrink,
// so on a tablet the heading gives way and the two pills stay on one row.
// The ring stays tangerine: `--ring` flips with the rest.
