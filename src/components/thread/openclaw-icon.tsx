...
// The OpenClaw mascot from the "Import from OpenClaw" option card, copied
// verbatim from docs/reference/pages/thread-detail.html (not a lucide icon).
// The gradient id is generated per instance so two icons on one page do not
// collide.
