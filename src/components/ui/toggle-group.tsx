...
// Phase 2: a joined group (spacing 0) is one pill track; each item keeps its
// tint states from toggle.tsx.
...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] rounded-full data-[spacing=0]:bg-tint-7 data-[spacing=0]:p-0.5 data-vertical:flex-col data-vertical:items-stretch",
        className,
      )}
      {...props}
    >
