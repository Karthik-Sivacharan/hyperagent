...
// Class strings are the ones hyperagent.com renders (docs/reference/overlays/
// account-menu.html, new-agent-menu.html, thread-options-menu.html ...): the
// classic shadcn v4 dropdown-menu with `cursor-pointer` items. Sub content is
// rendered inline (no portal), exactly as on the site.
