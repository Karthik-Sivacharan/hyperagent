...
// Class strings follow the thread right-click menu hyperagent.com renders
// (docs/reference/overlays/thread-context-menu.html): the classic shadcn v4
// context-menu with `cursor-pointer` items.
