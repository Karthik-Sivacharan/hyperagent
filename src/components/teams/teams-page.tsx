      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="flex h-full items-center justify-center">
            <div className="max-w-md rounded-lg border border-border/60 border-dashed p-8 text-center">
              <Users className="mx-auto mb-3 size-10 text-muted-foreground" aria-hidden="true" />
              <p className="font-medium text-base">You&apos;re not on any teams yet</p>
