...
// line of state a run shows under its title, in words. The board card, the
// list row and the sheet's run row each keep a copy of this function until
// the orchestrator folds them into fleet/run-caption.ts; this copy matches
// list/run-caption.ts line for line.
//
//   needs you    the ask
